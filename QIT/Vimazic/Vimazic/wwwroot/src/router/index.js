            ...
            children: [
                {
                    ...
                    component: () => import(/* webpackChunkName: "dist/components/home" */ '@/views/home')
                },
                {
                    path: 'system',
                    name: 'system',
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/users/list" */ '@/views/system/users/list')
                                },
                                {
                                    path: 'create',
                                    name: 'create_user',
                                    meta: { label: 'Thêm mới người dùng', requiresAuth: true, requiresPrivileges: ['ManageUser'] },
                                    component: () => import(/* webpackChunkName: "dist/components/system/users/create" */ '@/views/system/users/create')
                                },
                                {
                                    path: 'detail/:userId',
                                    name: 'user_detail',
                                    meta: { label: 'Thông tin người dùng', requiresAuth: true, requiresPrivileges: ['ViewUser', 'ManageUser'] },
                                    component: () => import(/* webpackChunkName: "dist/components/system/users/detail" */ '@/views/system/users/detail')
                                },
                                {
                                    path: 'privileges/:userId',
                                    name: 'user_privileges',
                                    meta: { label: 'Phân quyền người dùng', requiresAuth: true, requiresPrivileges: ['ManageUser'] },
                                    component: () => import(/* webpackChunkName: "dist/components/system/users/privileges" */ '@/views/system/users/privileges')
                                }
                            ]
                        },
                        {
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/roles/list" */ '@/views/system/roles/list')
                                },
                                {
                                    path: 'create',
                                    name: 'create_role',
                                    meta: { label: 'Thêm mới nhóm người dùng', requiresAuth: true, requiresPrivileges: ['ManageRole'] },
                                    component: () => import(/* webpackChunkName: "dist/components/system/roles/create" */ '@/views/system/roles/create')
                                },
                                {
                                    path: 'detail/:roleId',
                                    name: 'role_detail',
                                    meta: { label: 'Thông tin nhóm người dùng', requiresAuth: true, requiresPrivileges: ['ViewRole', 'ManageRole'] },
                                    component: () => import(/* webpackChunkName: "dist/components/system/roles/detail" */ '@/views/system/roles/detail')
                                },
                                {
                                    path: 'privileges/:roleId',
                                    name: 'role_privileges',
                                    meta: { label: 'Phân quyền nhóm người dùng', requiresAuth: true, requiresPrivileges: ['ManageRole'] },
                                    component: () => import(/* webpackChunkName: "dist/components/system/roles/privileges" */ '@/views/system/roles/privileges')
                                }
                            ]
                        },
                        {
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/exploitation-users/list" */ '@/views/system/exploitation-users/list')
                                },
                                {
                                    path: 'create',
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/exploitation-users/create" */ '@/views/system/exploitation-users/create')
                                },
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/exploitation-users/detail" */ '@/views/system/exploitation-users/detail')
                                },
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/exploitation-users/privileges" */ '@/views/system/exploitation-users/privileges')
                                }
                            ]
                        },
                        {
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/exploitation-roles/list" */ '@/views/system/exploitation-roles/list')
                                },
                                {
                                    path: 'create',
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/exploitation-roles/create" */ '@/views/system/exploitation-roles/create')
                                },
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/exploitation-roles/detail" */ '@/views/system/exploitation-roles/detail')
                                },
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/exploitation-roles/privileges" */ '@/views/system/exploitation-roles/privileges')
                                }
                            ]
                        },
                        {
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/sync-users/list" */ '@/views/system/sync-users/list')
                                },
                                {
                                    path: 'create',
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/sync-users/create" */ '@/views/system/sync-users/create')
                                },
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/sync-users/detail" */ '@/views/system/sync-users/detail')
                                }
                            ]
                        },
                        {
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/sync-roles/list" */ '@/views/system/sync-roles/list')
                                },
                                {
                                    path: 'create',
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/sync-roles/create" */ '@/views/system/sync-roles/create')
                                },
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/sync-roles/detail" */ '@/views/system/sync-roles/detail')
                                },
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/sync-roles/privileges" */ '@/views/system/sync-roles/privileges')
                                }
                            ]
                        },    
                        {
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/system-parameters/create" */ '@/views/system/system-parameters/create')
                                }
                            ]
                        },
                        {
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/system/report-parameters/create" */ '@/views/system/report-parameters/create')
                                }
                            ]
                        }
                    ]
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/unit-types/list" */ '@/views/master-data/unit-types/list')
                                },
                                {
                                    path: 'create',
                                    name: 'create_unit_type',
                                    meta: { label: 'Thêm mới phân loại đơn vị', requiresAuth: true, requiresPrivileges: ['ManageUnitType'] },
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/unit-types/create" */ '@/views/master-data/unit-types/create')
                                },
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/unit-types/detail" */ '@/views/master-data/unit-types/detail')
                                }
                            ]
                        },
                        {
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/units/list" */ '@/views/master-data/units/list')
                                },
                                {
                                    path: 'create',
                                    name: 'create_unit',
                                    meta: { label: 'Thêm mới đơn vị', requiresAuth: true, requiresPrivileges: ['ManageUnit'] },
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/units/create" */ '@/views/master-data/units/create')
                                },
                                {
                                    path: 'edit/:unitId',
                                    name: 'edit_unit',
                                    meta: { label: 'Sửa đơn vị', requiresAuth: true, requiresPrivileges: ['ViewUnit', 'ManageUnit'] },
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/units/edit" */ '@/views/master-data/units/edit')
                                }
                            ]
                        },
                        {
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/countries/list" */ '@/views/master-data/countries/list')
                                },
                                {
                                    path: 'create',
                                    name: 'create_country',
                                    meta: { label: 'Thêm mới quốc gia', requiresAuth: true, requiresPrivileges: ['ManageCountry'] },
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/countries/create" */ '@/views/master-data/countries/create')
                                },
                                {
                                    path: 'detail/:countryId',
                                    name: 'country_detail',
                                    meta: { label: 'Thông tin quốc gia', requiresAuth: true, requiresPrivileges: ['ViewCountry', 'ManageCountry'] },
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/countries/detail" */ '@/views/master-data/countries/detail')
                                }
                            ]
                        },
                        {
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/regions/list" */ '@/views/master-data/regions/list')
                                },
                                {
                                    path: 'create',
                                    name: 'create_region',
                                    meta: { label: 'Thêm mới địa bàn', requiresAuth: true, requiresPrivileges: ['ManageRegion'] },
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/regions/create" */ '@/views/master-data/regions/create')
                                },
                                {
                                    path: 'detail/:regionId',
                                    name: 'region_detail',
                                    meta: { label: 'Thông tin địa bàn', requiresAuth: true, requiresPrivileges: ['ViewRegion', 'ManageRegion'] },
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/regions/detail" */ '@/views/master-data/regions/detail')
                                }
                            ]
                        },
                        {
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/asset-types/list" */ '@/views/master-data/asset-types/list')
                                },
                                {
                                    path: 'create',
                                    name: 'asset_type_create',
                                    meta: { label: 'Thêm mới loại tài sản', requiresAuth: true, requiresPrivileges: ['ManageAssetType'] },
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/asset-types/create" */ '@/views/master-data/asset-types/create')
                                },
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/asset-types/edit" */ '@/views/master-data/asset-types/edit')
                                }
                            ]
                        },
                        {
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/increasement-causes/list" */ '@/views/master-data/increasement-causes/list')
                                },
                                {
                                    path: 'create',
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/increasement-causes/create" */ '@/views/master-data/increasement-causes/create')
                                },
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/increasement-causes/detail" */ '@/views/master-data/increasement-causes/detail')
                                },
                            ]
                        },
                        {
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/decreasement-causes/list" */ '@/views/master-data/decreasement-causes/list')
                                },
                                {
                                    path: 'create',
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/decreasement-causes/create" */ '@/views/master-data/decreasement-causes/create')
                                },
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/decreasement-causes/detail" */ '@/views/master-data/decreasement-causes/detail')
                                },
                            ]
                        },
                        {
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/asset-sources/list" */ '@/views/master-data/asset-sources/list')
                                },
                                {
                                    path: 'create',
                                    name: 'asset_source_create',
                                    meta: { label: 'Thêm mới nguồn hình thành tài sản', requiresAuth: true, requiresPrivileges: ['ManageUser'] },
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/asset-sources/create" */ '@/views/master-data/asset-sources/create')
                                },
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/asset-sources/detail" */ '@/views/master-data/asset-sources/detail')
                                },
                            ]
                        },
                        {
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/asset-usage-states/list" */ '@/views/master-data/asset-usage-states/list')
                                },
                                {
                                    path: 'create',
                                    name: 'asset_usage_states_create',
                                    meta: { label: 'Thêm mới hiện trạng sử dụng', requiresAuth: true, requiresPrivileges: ['ManageUser'] },
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/asset-usage-states/create" */ '@/views/master-data/asset-usage-states/create')
                                },
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/asset-usage-states/detail" */ '@/views/master-data/asset-usage-states/detail')
                                },
                            ]
                        },
                        {
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/asset-usage-purposes/list" */ '@/views/master-data/asset-usage-purposes/list')
                                },
                                {
                                    path: 'create',
                                    name: 'asset_usage_purposes_create',
                                    meta: { label: 'Thêm mới hiện trạng sử dụng', requiresAuth: true, requiresPrivileges: ['ManageUser'] },
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/asset-usage-purposes/create" */ '@/views/master-data/asset-usage-purposes/create')
                                },
                                {
                                    path: 'detail/:assetUsagePurposeId',
                                    name: 'asset_usage_purposes_detail',
                                    meta: { label: 'Thông tin hiện trạng sử dụng', requiresAuth: true, requiresPrivileges: ['ManageUser'] },
                                    component: () => import(/* webpackChunkName: "dist/components/master-data/asset-usage-purposes/detail" */ '@/views/master-data/asset-usage-purposes/detail')
                                },
                            ]
                        },
                    ]
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/manage-data/assets/list" */ '@/views/manage-data/assets/list')
                                },
                                {
                                    path: 'detail/:assetId',
                                    name: 'assets_detail',
                                    meta: { label: 'Thông tin tài sản', requiresAuth: true, requiresPrivileges: ['ManageAsset'] },
                                    component: () => import(/* webpackChunkName: "dist/components/manage-data/assets/detail" */ '@/views/manage-data/assets/detail')
                                },
                            ...
                            children: [
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/manage-data/asset-mutations/list" */ '@/views/manage-data/asset-mutations/list')
                                },
                                {
                                    path: 'list/:assetId',
                                ...
                                },
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/manage-data/asset-mutations/detail" */ '@/views/manage-data/asset-mutations/detail')
                                },
                            ...
                            children: [
                                {
                                    ...
                                    meta: { label: 'Danh sách tài sản', requiresAuth: true, requiresPrivileges: ['ViewAsset'] },
                                    component: () => import(/* webpackChunkName: "dist/components/search/synced-assets/list" */ '@/views/search/synced-assets/list')
                                },
                                {
                                    ...
                                    component: () => import(/* webpackChunkName: "dist/components/search/synced-assets/detail" */ '@/views/search/synced-assets/detail')
                                },
                ...
                },
                {
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            component: () => import(/* webpackChunkName: "dist/components/logs/action-logs/list" */ '@/views/logs/action-logs/list')
                        }]
                    }]
                }
            ]
