    ...
    <div class="animated fadeIn">
        <b-row>
            <b-col lg="12">
                <b-card>
                    <div slot="header">
                        <strong>Phân quyền nhóm tài khoản đơn vị đồng bộ</strong>
                    </div>
                    <b-form @submit.prevent="save" style="min-height: 500px">
                        <b-row>
                            ...
                            <b-col md="8">
                                <b-form-group :label="'Chuyên mục ' + selectedModule.name.toLowerCase()" v-if="selectedModule"
                                    ...
                                    <b-form-checkbox-group id="privileges" v-model="rolePrivileges" class="checkbox-group">
                        ...
                        <b-row>
                            <b-col md="8" offset="4">
                                <b-button type="submit" variant="primary"><i class="fa fa-floppy-o"></i> Ghi lại</b-button>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.$services.get(`sync-roles/${this.$route.params.syncRoleId}/privileges`).done((privileges) => {
        ...
        methods: {
            ...
            save() {
                ...
                this.$services.put(`sync-roles/${this.$route.params.syncRoleId}/privileges`, { privileges: this.rolePrivileges }).done(() => {
                    vm.$toastr.s('Phân quyền nhóm tài khoản đơn vị đồng bộ thành công.');
                    vm.cancel();
                });
            },
            cancel() {
